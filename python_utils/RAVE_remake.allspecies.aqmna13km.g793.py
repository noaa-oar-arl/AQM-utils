...
def RAVE_remake_allspecies(date, cyc, input_fire, output_fire):
    ...
    setattr(fout, r"WestBoundingCoordinate\(degree\)", "151.981f")
    setattr(fout, r"EastBoundingCoordinate\(degree\)", "332.019f")
    setattr(fout, r"NorthBoundingCoordinate\(degree\)", "81.7184f")
    setattr(fout, r"SouthBoundingCoordinate\(degree\)", "7.22291f")
